...
public class Stores {
    ...
    public Store getOrCreateBy(FileChannelFactory fileChannelFactory) throws IOException {
        ...
        return buffer != null ? buffer : mapBy(fileChannelFactory);
    }
    ...
    private Store mapBy(FileChannelFactory mapper) throws IOException {
        try {
            tryRelease();
    ...
    private InnerStore tryMapBy(FileChannelFactory mapper) throws IOException {
        InnerStore buffer = new InnerStore(mapper);
