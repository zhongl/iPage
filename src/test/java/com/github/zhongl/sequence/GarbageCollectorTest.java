...
public class GarbageCollectorTest {
    ...
    public void setUp() throws Exception {
        ...
        collector = new GarbageCollector<String>(linkedPages, 16L);
    }

    @Test
    public void emptyList() throws Exception {
        assertThat(collector.collect(new Cursor(0L), new Cursor(15L)), is(0L));
    }

    @Test
    public void beginEqualEnd() throws Exception {
        linkedPages.add(mockLinkedPage(0L, 4095L));
        assertThat(collector.collect(new Cursor(15L), new Cursor(15L)), is(0L));
    }

    @Test
    public void beginGreaterThanEnd() throws Exception {
        linkedPages.add(mockLinkedPage(0L, 4095L));
        assertThat(collector.collect(new Cursor(15L), new Cursor(7L)), is(0L));
    }
    ...
    public void tooSmallToCollect() throws Exception {
        ...
        assertThat(collector.collect(new Cursor(0L), new Cursor(32L)), is(0L));
    }
    ...
    public void collectInOneLinkedPage() throws Exception {
        ...
        linkedPages.add(page);
        assertThat(collector.collect(new Cursor(15L), new Cursor(64L)), is(64 - 15L));
    }
    ...
    public void collectBetweenTwoLinkedPage() throws Exception {
        ...
        assertThat(collector.collect(new Cursor(15L), new Cursor(4112L)), is(4112 - 15L));
    ...
    public void collectHoleLeft() throws Exception {
        ...
        assertThat(collector.collect(new Cursor(0L), new Cursor(4112L)), is(4112L));
    }
    ...
    public void endOffsetOutOfListHasOnlyElement() throws Exception {
        ...
        assertThat(collector.collect(new Cursor(0L), new Cursor(4096L)), is(0L));
    }
    ...
    public void collectOnlyLeft() throws Exception {
        ...
        assertThat(collector.collect(new Cursor(15L), new Cursor(4096L)), is(4096 - 15L));
    }
